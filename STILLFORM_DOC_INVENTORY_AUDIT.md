...
**v1.2 — May 12, 2026 (later that day).** Phase D MEDIUM priority spot-checks SCANNED and addressed where actionable:
- CHIP_DEFINITIONS_DRAFT.md — CLEAN (no framing violation patterns detected)
- CLOSING_LANGUAGE_CANDIDATES.md — CLEAN
- PLAIN_LANGUAGE_SCIENCE_CARD_SPEC.md — CLEAN
- SELF_MODE_REDESIGN_RESEARCH.md — TWO VIOLATIONS FIXED: line 51 "any other regulation app" → "any other practice in this space"; line 126 "composure architecture is built FROM..." → "the practice is built FROM..." Top-of-doc supersession note added pointing readers to STILLFORM_FRAMING_LAW.md for current product framing. The substance of the Self Mode redesign (body-first when arousal is high, past self → present self, AI-down resilience) remains valid under the framing law.
- STILLFORM_ENGAGEMENT_ARCHITECTURE.md — BORDERLINE: the Roadmap section uses "Stages of self-mastery" as the umbrella term for the user's journey. Under the framing law, Bandura (1977) self-efficacy/sense of mastery is in the science spine, so "mastery" as an OUTCOME is valid; but the UMBRELLA framing needs Arlin's structural review before any external-facing surfaces (App Store, marketing, partner outreach) use the phrase. The stage names themselves (NOTICING → NAMING → ANTICIPATING → RECOGNIZING → HOLDING) are framing-law-aligned. Supersession note added at top of doc flagging this for structural review without forcing a premature rewrite.

**Status summary as of v1.2:** 10 of 10 HIGH priority targets have meaningful framing-law alignment. 5 of 5 MEDIUM priority docs scanned and aligned (4 cleanly, 1 with structural review flagged). All 14 inventory targets now have either: (a) full framing-law alignment, (b) surgical fixes applied + supersession note, or (c) supersession note flagging structural review needed. The framing rebuild's gate-keeping infrastructure (STILLFORM_FRAMING_LAW.md + STILLFORM_AUDIT_PHILOSOPHY.md v2.0 Layer 0) catches new drift at usage time.
