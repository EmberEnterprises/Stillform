  ...
  return (
    <button
      ...
      style={{
        ...
        border: "none",
        borderTop: `0.5px solid ${on ? "var(--sf-state-negative)" : "var(--sf-border-emphasis, rgba(255,255,255,0.10))"}`,
        borderBottom: `0.5px solid ${on ? "var(--sf-state-negative)" : "var(--sf-border-emphasis, rgba(255,255,255,0.10))"}`,
        padding: "7px 14px",
        fontFamily: "var(--sf-font-mono, monospace)",
        fontSize: "10px",
        letterSpacing: "0.18em",
        textTransform: "uppercase",
        color: on ? "var(--sf-state-negative)" : "var(--sf-text-quiet, rgba(232,234,240,0.62))",
        cursor: "pointer",
