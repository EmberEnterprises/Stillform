...
const THEME_PRESETS = {
  ...
  teal: {
    ...
    "--surface": "#0a1f21",
    "--surface2": "#102829",
    "--border": "rgba(80,160,155,0.22)",
    "--border-hi": "rgba(80,160,155,0.40)",
    "--amber": "#4a9e98",
    "--amber-dim": "rgba(74,158,152,0.30)",
    "--amber-glow": "rgba(74,158,152,0.10)",
    "--amber-20": "rgba(74,158,152,0.20)",
    "--text": "#ffffff",
    "--text-dim": "#a8ceca",
    "--text-muted": "#5e9e98",
    "--green": "#4a9e98",
    "--green-glow": "rgba(74,158,152,0.12)"
  },
  rose: {
    "--bg": "#0e090c",
    "--surface": "#1c1018",
    "--surface2": "#241520",
    "--border": "rgba(170,100,118,0.22)",
    "--border-hi": "rgba(170,100,118,0.38)",
    "--amber": "#9e5568",
    "--amber-dim": "rgba(158,85,104,0.30)",
    "--amber-glow": "rgba(158,85,104,0.10)",
    "--amber-20": "rgba(158,85,104,0.20)",
    "--text": "#f8eef2",
    "--text-dim": "#c8a0ae",
    "--text-muted": "#8e6070",
    "--green": "#9e5568",
    "--green-glow": "rgba(158,85,104,0.10)"
  },
  light: {
    "--bg": "#f0f2f8",
    "--surface": "#ffffff",
      ...
      <div className={appClasses}>
        ...
        {screen === "setup-bridge" && (() => {
          ...
          const themeOptions = [
            ...
            { id: "teal",     label: "Teal",      bg: "#030d0e", accent: "#4a9e98" },
            { id: "rose",     label: "Rose",      bg: "#0e090c", accent: "#9e5568" },
