...
function AIConsultTool() {
  ...
  return (
    <div>
      <div className="disclaimer">
        This is not therapy or crisis intervention. For emergencies, call 988 (Suicide & Crisis Lifeline) or 911. This tool is a calm, structured space to process what you're experiencing.
      </div>
      ...
      <div className="app">
        ...
        {screen === "tools" && (
          <section className="tools">
            ...
            <div className="disclaimer">
              Stillform is not a substitute for professional mental health treatment. If you are in crisis, please contact the 988 Suicide & Crisis Lifeline by calling or texting 988.
            </div>
        ...
        {screen === "privacy" && (
          <section className="privacy">
            ...
            <p>Stillform is not medical treatment, therapy, or a crisis intervention service. It is a composure tool. If you are experiencing a mental health crisis, please contact the 988 Suicide & Crisis Lifeline (call or text 988) or your local emergency services.</p>
