...
const checks = [
  ...
  { label: "Tutorial page titles locked", cmd: "rg", args: ["-n", "title: \"System sequence\"|title: \"Setup tool \\(combined\\)\"|title: \"Daily execution tools\"|title: \"Close and track progress\"", "src/App.jsx"], type: "must-match" },
