...
const checks = [
  ...
  { label: "Tutorial multi-page progression", cmd: "rg", args: ["-n", "Tutorial · 1 of 10|Tutorial · 2 of 10|Tutorial · 3 of 10|Tutorial · 4 of 10|Tutorial · 5 of 10|Tutorial · 6 of 10|Tutorial · 7 of 10|Tutorial · 8 of 10|Tutorial · 9 of 10|Tutorial · 10 of 10", "src/App.jsx"], type: "must-match" },
  { label: "Tutorial page titles locked", cmd: "rg", args: ["-n", "title: \"Calibration — Build Your Baseline\"|title: \"Morning Check-In — Set the Day’s Baseline\"|title: \"Daily Regulation Tools — Your Active Layer\"|title: \"Reframe — Convert Reaction into Strategy\"|title: \"Breathe — Composure Reset\"|title: \"Body Scan — Release What You’re Carrying\"|title: \"End-of-Day Close — Consolidate the Day\"|title: \"Pulse — Capture Signal in Context\"|title: \"My Progress — Verify What Is Changing\"|title: \"Run the Full Loop Daily\"", "src/App.jsx"], type: "must-match" },
