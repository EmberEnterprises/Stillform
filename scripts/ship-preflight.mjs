...
const checks = [
  ...
  { label: "FAQ method and science entries", cmd: "rg", args: ["-n", "What is the method behind Stillform\\?|What science is Stillform built on\\?", "src/App.jsx"], type: "must-match" },
  { label: "FAQ method and science answers", cmd: "rg", args: ["-n", "Metacognitive Therapy, applied to daily life|The core shift: from|proven neuroscience", "src/App.jsx"], type: "must-match" },
