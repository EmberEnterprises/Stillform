...
const checks = [
  ...
  { label: "FAQ method and science answers", cmd: "rg", args: ["-n", "Metacognitive Therapy \\(Wells\\) applied to daily life\\. The core shift is from being inside a state to recognizing it clearly enough to choose your response\\.|Stillform draws from metacognitive therapy, behavioral and cognitive neuroscience, and stress-regulation research", "src/App.jsx"], type: "must-match" },
