...
const checks = [
  ...
  { label: "Tutorial multi-page progression", cmd: "rg", args: ["-n", "Tutorial · 1 of 6|Tutorial · 2 of 6|Tutorial · 3 of 6|Tutorial · 4 of 6|Tutorial · 5 of 6|Tutorial · 6 of 6", "src/App.jsx"], type: "must-match" },
  { label: "Tutorial page titles locked", cmd: "rg", args: ["-n", "title: \"Calibration — Build Your Baseline\"|title: \"Morning Check-In — Set the Day’s Baseline\"|title: \"Daily Tools — Prepare, Regulate, Recover\"|title: \"End-of-Day Close — Consolidate the Day\"|title: \"Pulse — Capture Signal, Track Progress\"|title: \"Run the Full Loop Daily\"", "src/App.jsx"], type: "must-match" },
