...
const checks = [
  ...
  { label: "Tutorial focus check briefing lock", cmd: "rg", args: ["-n", "Post-Check Briefing|Go / No-Go Quick Check → Morning Check-In → Daily Regulation Tools", "src/App.jsx"], type: "must-match" },
