...
const checks = [
  ...
  { label: "Tutorial page titles locked", cmd: "rg", args: ["-n", "title: \"This Setup Is For You\"|title: \"Cognitive Baseline — Your First Read\"|title: \"One Practice\\. Three Moments\\.\"|title: \"The Skill Builds Over Time\"", "src/App.jsx"], type: "must-match" },
