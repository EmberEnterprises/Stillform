...
const checks = [
  ...
  { label: "Focus check home and advanced entrypoints", cmd: "rg", args: ["-n", "Quick Check|Run Focus Check \\(30s\\)|screen === \"focus-check\"", "src/App.jsx"], type: "must-match" },
  { label: "Settings advanced controls gate", cmd: "rg", args: ["-n", "Advanced controls|settingsSectionOpen\\.advanced", "src/App.jsx"], type: "must-match" },
  ...
  { label: "Tutorial page titles locked", cmd: "rg", args: ["-n", "title: \"Calibration — Build Your Baseline\"|title: \"Go / No-Go Quick Check — Time to First Value\"|title: \"Morning Check-In — Set the Day’s Baseline\"|title: \"Daily Regulation Tools — Active Execution Layer\"|title: \"Run the Full Loop Daily\"", "src/App.jsx"], type: "must-match" },
  { label: "Tutorial focus check briefing lock", cmd: "rg", args: ["-n", "Post-Check Briefing|Go / No-Go Quick Check → Morning Check-In → Daily Regulation Tools|stillform_tutorial_instruments", "src/App.jsx"], type: "must-match" },
